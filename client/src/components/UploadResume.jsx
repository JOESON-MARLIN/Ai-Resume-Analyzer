...
export default function UploadResume({ userId }) {
    ...
    return (
        <div className="mx-auto max-w-md rounded-2xl border border-slate-200/60 bg-white/60 p-8 text-center backdrop-blur-sm mt-20">
            <div className="mb-4 text-5xl">📄</div>
            <h2 className="mb-1 text-lg font-bold text-black">Upload Your Resume</h2>
            <p className="mb-6 text-sm text-slate-600">
                PDF only · max 5 MB · parsed once, tailored forever
            </p>

            {phase === "error" && (
                <div className="mb-4 rounded-lg bg-blue-500/10 p-3 text-sm text-blue-600 border border-blue-500/20">
                    {message}
                </div>
            )}
            ...
            <button
                ...
                className={[
                    ...
                    isLoading
                        ...
                        : "cursor-pointer border-slate-600 text-slate-600 hover:border-blue-500 hover:bg-blue-500/5 hover:text-blue-300",
                ].join(" ")}
            >
                {isLoading ? (
                    <>
