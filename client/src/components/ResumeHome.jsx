...
export default function ResumeHome() {
    return (
        <div className="max-w-6xl mx-auto space-y-12 pb-10">
            ...
            {/* Hero Header */}
            <section className="bg-gradient-to-br from-blue-600 to-blue-300 rounded-3xl p-14 text-center text-white relative overflow-hidden group shadow-xl shadow-blue-500/20">
                ...
                <p className="text-white/80 font-medium text-lg max-w-2xl mx-auto relative z-10">
                    AI-powered resume analysis, tailoring, and ATS optimization
                </p>
            ...
            <section>
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500">Select your preferred analysis method</p>
                </div>
                    ...
                    <Link to="/resume/tailor-upload" className="block group">
                        <div className="bg-white border border-slate-200/60 rounded-2xl p-8 hover:border-blue-400 transition-all duration-300 transform group-hover:-translate-y-1 hover:shadow-2xl relative overflow-hidden h-full flex flex-col">
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-600 to-blue-300 flex items-center justify-center text-white text-xl shadow-lg shadow-blue-500/20">
                                    ↑
                                </div>
                                <h3 className="text-xl font-bold text-slate-800 group-hover:text-blue-600 transition">Enhance Existing Resume</h3>
                            </div>
                            ...
                            <div className="mt-auto">
                                ...
                                <ul className="space-y-2.5">
                                    {["Upload your PDF resume", "Paste Target Job Description", "Receive tailored optimizations instantly"].map((step, i) => (
